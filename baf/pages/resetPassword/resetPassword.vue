			...
			<view>
				<view class="form-padding">
					...
					<view class="submit-block">
						<my-button class="login-register-button"  type="primary" @click="summitMsg()">提交</my-button>
					</view>
				</view>
			</view>
		</view>
...
import { initWebSocket } from '../../utils/websocket';
	...
	import {requestCode,register,login, modPassword} from '@/utils/system/system.js'
	export default {
		data() {
			return {
				isLogin: true,
		...
		methods: {
			...
			summitMsg(){
				if(this.isSummitMsg) return
				this.isSummitMsg = true
				var data = {
					email: this.formData.email,
					password: this.formData.password,
					params:{
